...
def render(bundle, config: dict, embedded: bool = False) -> None:
    ...
    fig = go.Figure()
    fig.add_bar(x=labels, y=series["net_orders"], name="Net orders", marker_color="#0F766E")
    fig.add_bar(x=labels, y=series["not_delivered"], name="Not delivered", marker_color="#DC2626")
